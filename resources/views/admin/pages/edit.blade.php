                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pages.update', ['id' => $page->id]) }}" method="POST">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input @if(old('draft')||($page->draft)) checked="checked" @endif type="checkbox"
                            name="draft">
                            Ceci est un brouillon !
                        </div>
                        <div class="custom-control custom-checkbox">Actif :
                            <input @if(old('active')||($page->active)) checked="checked" @endif type="checkbox"
                            name="active">
                        ...
                        <div class="col-mb-12 mb-3 font-weight-bold">
                            ...
                            <div>
                                <textarea class="text-dark" name="content" id="content" style="width:100%"
                                    rows="5"> @if(old('content')) {{ old('content') }} @else {{ $page->content }} @endif </textarea>
                            </div>
                        </div>
